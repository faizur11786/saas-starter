    ...
    if (filter.operator === "is_empty" || filter.operator === "not_empty") {
      return (
        <div
          ...
          role="status"
          aria-live="polite"
          aria-label={`${filterField.label} filter is ${filter.operator === "is_empty" ? "empty" : "not empty"}`}
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        onValueChange={(value: FilterOperator) =>
                          updateFilter({
                            ...
                            field: {
                              operator: value,
                              value:
                                value === "is_empty" || value === "not_empty"
                                  ? ""
                                  : filter.value,
                            },
                          })
                      ...
                      >
                        ...
                        <SelectContent id={operatorListboxId}>
                          {getFilterOperators(filter.type).map((op: any) => (
                            <SelectItem key={op.value} value={op.value}>
                              {op.label}
                            </SelectItem>
                          ))}
